...
- `POST /check/output` — validates the LangGraph agent's complete assembled result: invented CRM facts, unsupported business conclusions, fake legal/financial promises, overconfident recommendations, invented call details, and missing `call_id` citations for historical-call claims.
